 ...
 * @author shaki_netsh
 */
public class Subdb extends javax.swing.JFrame {

    /**
     * Creates new form Subdb
     */
    public Subdb() {
        initComponents();
    ...
    public void table() {
        try {
            ResultSet rs = DB.getConnection().createStatement().executeQuery("select * from subjects");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SUBJECT&CLASS MANAGEMENT ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Subdb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
